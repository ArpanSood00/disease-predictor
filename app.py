...
def predict():
    ...
    input_data= {"age": age, "Gender": fgender, "Chest Pain Types": cp,
                 "Resting Blood Pressure(in mm/Hg)": trestbps, "Cholesterol Level": chol,
                 "is Fasting Blood Pressure>120mg/Dl?": fbs,
                 "Resting Electro Cardio Graphic Result": restecg,
                 "Maximum Heart Rate Achieved": thalach, "Does Exercise Induced Angina?": exang,
                 "Old Peak (ST Depression Induced by Exercise Relative to Rest)": oldpeak,
                 "Slope of ST Segment": slope,
                 "number of major vessels (0-3) colored by flourosopy": ca, "Thal Type": thal}
